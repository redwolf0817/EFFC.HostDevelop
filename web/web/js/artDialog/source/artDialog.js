...
artDialog.fn = artDialog.prototype = {
    ...
    */
    ...
    zIndex: function () {
        ...
        // 设置最高层的样式
        top && top.dom.statefocus.removeClass('d-statefocus');
    ...
    toMax:function(){
        ...
        dom.max.hide();
        dom.nom.show();
        that.size(dom.window.width(), dom.window.height()-40);
        dom.border.css("width","auto");
        that._reset();
    },
...
$(window).bind('resize', function () {
    ...
    for (var id in dialogs) {
        if(dialogs[id].isMax)
            dialogs[id].size(dialogs[id].dom.window.width(), dialogs[id].dom.window.height()-40);
        else
            dialogs[id]._reset();  
    };
});
...
+                                       '<a class="d-max" href="javascript:/*artDialog*/;"></a>'
+                                       '<a class="d-nom" href="javascript:/*artDialog*/;"></a>'
