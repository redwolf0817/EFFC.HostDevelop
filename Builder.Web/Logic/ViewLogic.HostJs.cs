...
namespace Builder.Web.Logic
{
    ...
    {
        ViewHostJsHelper _hjh = null;
        public new ViewHostJsHelper Js
        {
            get
            {
                if (_hjh == null) _hjh = new ViewHostJsHelper(this);
                return _hjh;
            }


        }
        public class ViewHostJsHelper:HostJsHelper
        {
            string jsrootpath = "";
            public ViewHostJsHelper(ViewLogic logic)
                : base(logic)
            {
            ...
            {
                return CallLocal(scriptpath, includes,FrameDLRObject.CreateInstance(),"output", p.ToList());
            }
            ...
            public object CallScriptString(string jsstr, string[] includes, FrameDLRObject input,string outputkey, List<KeyValuePair<string, object>> p)
            {
                ...
                var result = base.Call(scriptstr.ToString(), input,outputkey, p.ToArray());
            ...
            public FrameDLRObject CallByPath(string scriptpath, FrameDLRObject input, List<KeyValuePair<string, object>> p, params string[] includes)
            {
                ...
                return CallLocal(scriptpath, lpincludes.ToArray(), input, "output", p);
            ...
            public FrameDLRObject CallByPath(string scriptpath, FrameDLRObject input, params KeyValuePair<string, object>[] p)
            {
                ...
                return CallLocal(scriptpath, new string[] { "~/common.js" }, input, "output", lp);
